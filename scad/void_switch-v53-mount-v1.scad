...
STEM_TOLERANCE = 0.15; // [0.01:0.01:0.3] 0.16 0.18 0.2
...
BODY_MAGNET_DIAMETER = 4; // [3:1:5] 4 - 5.97
...
BODY_MAGNET_HEIGHT = 1.7; // [1:0.1:3] 1.7 - 2.97
...
STEM_MAGNET_DIAMETER_TOLERANCE = -0.32;
...
SHEATH_MAGNET_DIAMETER_TOLERANCE = 0.08; // EDIT: 0.1
...
SHEATH_MAGNET_WALL_TOLERANCE = 0.12;
...
// Renders a heat set mount in the corner of the switch body, giving an anchor point for a housing for the electronics under the switch.  This is useful for boards with abnormal switch alignment, like the Dactyl and Dactyl Manuform.
BODY_HEAT_SET = true;

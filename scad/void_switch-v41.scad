...
STEM_MAGNET_DIAMETER_TOLERANCE = -0.12;
...
MAGNET_WALL_THICKNESS = 0.4; // EDIT: 0.5
...
SHEATH_MAGNET_WALL_TOLERANCE = 0.15;
...
for (item=RENDER) {
    if (item=="body") {
        ...
        color("blue") translate([BODY_LENGTH/1.05,0,0]) // Move it over to the side (but keep it tight so we can print more at a time!)
